- [[Sessions]]:
  collapsed:: true
	- Kampf gegen die Pirahnapflanze
	- [[Turtle Dagger]] gefunden
	- [[Nethercrag]] ist begeistert von den [[Namenlosen]]
	- [[Querzix]] träumt von [[Sister Garale]] und befragt Kelp
	- Gruppe geht auf einen schwarzen Turm und weckt den Wächter.
	- Für's nächste Mal: Wächter ist Sister Garelle
- [[Vorbereitung]]
	...
	- [[Quinzi]] Artifakte:
	  collapsed:: true
		- Händler: [[Durga Bristlebraid]]
	- [[Quinzi]] Tränke:
		- Händler: [[Skrig & Brandy]]:
		- Liste mit Nachteilen:
			- ### 🍶  **Skrig & Blarn’s Curious Concoctions for the Occult Adept (Lvl 9 Wizard)**
			  
			  | **Potion Name** | **Contained Object** | **Effect** | **Drawback** | **Price (gp)** |
			  | ---- | ---- | ---- |
			  | **1. Mind's Ember** | Flickering tooth-shaped coal | +2 to Spell Save DC for 1 minute | You take 1d6 psychic damage per spell cast during duration | 900 |
			  | **2. Clockdrop Elixir** | Tiny ticking pocketwatch | Cast *Time Stop* once | Lose 1 minute of real time from your memory | 2000 |
			  | **3. Shroomspore Draught** *(Mushroom-themed)* | Mini glowing toadstool bobbing in brine | Cast *Conjure Woodland Beings* (only fungal creatures) once | Mild hallucinogenic effect for 10 minutes (disadv. on Investigation) | 650 |
			  | **4. Phoenix Vial** | A single burning feather | Upon reaching 0 HP, explode in flame and revive with 1 HP | Nearby allies take 2d6 fire damage | 1600 |
			  | **5. Ink of the Abyss** | Eyeball floating in black ink | Gain Truesight 60 ft for 10 minutes | You can’t distinguish color for 1 hour | 750 |
			  | **6. Feathergrip Fizz** | A hummingbird feather | Levitate at will for 5 minutes | Cannot speak while levitating | 400 |
			  | **7. Whisperbottle** | Shrivelled ear inside | Gain *Detect Thoughts* for 10 minutes | Hear faint whispers for 1 hour afterwards (disadv. on Perception) | 600 |
			  | **8. Vial of Candleglass** | A slowly melting candle | Cast *Wall of Force* once | For 1 hour, bright light causes pain (disadv. on attack rolls in sunlight) | 1800 |
			  | **9. Frost-Jade Syrup** | Tiny ice dragon scale | Cast *Cone of Cold* at 6th level | Vulnerable to fire for next hour | 1500 |
			  | **10. Silver Tongue Sip** | Silver tongue-shaped sliver | +10 Persuasion for 1 hour | Involuntarily lie once (DM decides when) | 700 |
			  | **11. Blooddrop Nectar** | Preserved drop of unknown blood | Restore all expended spell slots of 3rd level and below | Next long rest offers no recovery | 1200 |
			  | **12. Emberblot Brew** | Tiny scorched quill | Gain ability to cast *Fireball* at 4th level twice | Must write your name in blood afterward or suffer 2d10 psychic damage | 1100 |
			  | **13. Mirrorwine** | Shard of glass, rippling | Cast *Mirror Image* for 1 hour (not concentration) | Your reflection moves independently for 24 hours, possibly attracting attention | 950 |
			  | **14. Scarabshine Serum** | Preserved jeweled beetle | +2 AC for 10 minutes | Attracts bugs; you’re swarmed if outdoors (DC 15 Con save or Poisoned) | 800 |
			  | **15. Bonebell Tonic** | Tiny ringing bell made of bone | Speak with Dead once (no components) | Your own voice echoes faintly for 6 hours | 550 |
			  | **16. Prism Elixir** | Rotating crystal pyramid | Cast *Prismatic Spray* once | You are blinded for 1d4 rounds after casting | 1900 |
			  | **17. Sphinxroot Decoction** | Dried cat paw wrapped in vine | Solve any riddle or puzzle with perfect clarity | You speak only in riddles for 10 minutes | 300 |
			  | **18. Ashkiss Draught** | Burnt rosebud suspended in wine | Become immune to necrotic damage for 10 minutes | Vulnerable to radiant damage during same time | 750 |
			  | **19. Hexhoney Flask** | Glowing wasp encased in honey | Cast *Hex* at 4th level, no concentration required | All Charisma checks are made at disadvantage for 1 hour | 950 |
			  | **20. Moondrop Tincture** | A tiny, luminous crescent moon | Can teleport up to 100 ft as a bonus action, 3x in 10 mins | If used more than once, risk being banished to the Feywild (DC 15 Cha save) | 1300 |
	-